...
Here we have specified knots at ages 25, 40, and 60.
...
We now fit using smoothing splines rather than natural splines.
We will need to use the =gam= library in =R=.
